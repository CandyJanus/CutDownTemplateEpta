...
import data.scripts.world.systems.epta.sevencorp_AddMarketplace;
...
public class bushido_meiyoGen {
    ...
    public void generate(SectorAPI sector) {
     ...
     // Another heaten productor
        ...
        MarketAPI meiyo_2_market = sevencorp_AddMarketplace.addMarketplace("pirates",
                meiyo_2,
                null,
                "Hitoreben",
                5,
     ...
     // Excelling terran world, for classic racers and such
        ...
        MarketAPI meiyo_3_market = sevencorp_AddMarketplace.addMarketplace("pirates",
                meiyo_3,
                null,
                "Oashisu",
                5,
...
//        meiyo_3_market.getIndustry(Industries.LIGHTINDUSTRY).setAICoreId(Commodities.GAMMA_CORE);
     ...
     // First Moon of Oashisu
        ...
        MarketAPI meiyo_4_market = sevencorp_AddMarketplace.addMarketplace("pirates",
                meiyo_4,
                null,
                "Nosu",
                4,
     ...
     // Second Moon of Oashisu
        ...
        MarketAPI meiyo_5_market = sevencorp_AddMarketplace.addMarketplace("pirates",
                meiyo_5,
                null,
                "Ninami",
                4,
...
//        meiyo_5_market.getIndustry(Industries.MINING).setAICoreId(Commodities.GAMMA_CORE);
	 ...
	 // Relay/Buoy/Array
        //note: the base id is not the type. the type is the top level string.
